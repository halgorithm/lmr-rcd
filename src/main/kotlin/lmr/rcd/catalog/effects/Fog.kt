...
: EffectDecorator(effect) {
    ...
    var defaultBlendMode by EnumParamAccessor(Param.DEFAULT_BLEND_MODE, BlendMode)
    var srcBlendMode by EnumParamAccessor(Param.SRC_BLEND_MODE, BlendMode)
    var destBlendMode by EnumParamAccessor(Param.DEST_BLEND_MODE, BlendMode)
